...
const { getAllAyaRegEntries, createAyaRegEntry, deleteAyaBill, insertReplaceCustomerDetails, updateAssignedDetail, updateAyaBill, updateReplaceCustomerDetails, getAyaRegEntryById, updateAyaRegEntryById, deleteAyaRegEntryById, deleteCustomerAssignedByid } = require('../controllers/AyaController');

const { getAllCustomerRegEntries, deleteCustomerBill, updateReplaceAyaDetails, insertReplaceAyaDetails, createCustomerRegEntry, updateCustomerBill, updateCustomerRegEntryById, deleteCustomerRegEntryById, getCustomerRegEntryById, getCustomerCode, deleteassignedAyaDetailsyId, } = require('../controllers/CustomerContoller');
...
// running delete specifice
router.delete('/deleteAssignedaya/:customerId/:index', deleteassignedAyaDetailsyId);
router.delete('/deleteCustomeraya/:ayaId/:index', deleteCustomerAssignedByid);


// router.delete('/deleteAssignedaya/:customerId/:assignedAyaId', deleteassignedAyaDetailsyId);
// router.delete('/deleteCustomeraya/:ayaId/:customerId', deleteCustomerAssignedByid);

// router.delete('/deleteassignedaya/:id', deleteassignedAyaDetailsyId);
